    ...
    return (
        <div className="bg-white flex justify-center items-center py-10">
            <div className="max-w-6xl bg-white justify-center text-center items-center m-0 py-10">
                ...
                <p className="text-gray-400">We pride ourselves in offering a comprehensive suite of services tailored to meet your unique real estate needs.</p>
                ...
                <div className="grid grid-cols-3 gap-10 my-8">
                    ...
                    {features.map((feature) => (
                        <div
                            key={feature.title}
                            className="bg-[#050B1C] h-auto w-70 rounded-3xl justify-center items-center py-10 px-6 hover:scale-105 transition-all duration-400"
                        >
