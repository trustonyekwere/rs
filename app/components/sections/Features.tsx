...
const Features = () => {
    return (
        <div className="bg-white flex justify-center items-center py-10" id="features">
            <div className="mx-auto max-w-6xl bg-white justify-center text-center items-center m-0 py-10 px-4">
                <h3 className="text-yellow-500 font-bold text-lg">Our Features</h3>
